...
Теперь надо установить связь между локальным репозиторием и удалённым, для этого надо использовать команду **git remote add <ввести адрес удалённого репозитория>**
